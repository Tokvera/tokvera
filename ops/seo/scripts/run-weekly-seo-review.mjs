...
function usage() {
  console.log(`Usage:\n  node ops/seo/scripts/run-weekly-seo-review.mjs --tracker <tracker.csv> --pages-7d <pages.csv> --queries-7d <queries.csv> --pages-28d <pages.csv> --queries-28d <queries.csv> [--base-url <url>] [--out-tracker <tracker.csv>] [--out-report <report.md>]`);
}
...
function main() {
  ...
  const metadataScript = path.join(repoRoot, "ops", "seo", "scripts", "snapshot-page-metadata.mjs");
